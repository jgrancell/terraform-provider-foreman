...
const (
	...
	ServerHostnameEnv string = "FOREMAN_SERVER_HOSTNAME"
)
	...
	return &schema.Provider{
		...
		Schema: map[string]*schema.Schema{
			...
			"server_hostname": &schema.Schema{
				...
				Description: "The hostname / IP address of the Foreman REST API server. This can " +
					"also be set through the environment variable `FOREMAN_SERVER_HOSTNAME`. ",
			},
