	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"comment": &schema.Schema{
				...
				Description:  "Add additional information about this host.",
			},
...
func resourceForemanHostRead(d *schema.ResourceData, meta interface{}) error {
	...
	// readHost for nonexistent host will have zero value for struct
	// so Id will be 0 and Name will be empty string
	if readHost.Id == 0 && readHost.Name == "" {
		d.SetId("")
		return nil
	}
